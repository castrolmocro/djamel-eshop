...
const oauthProviders: { id: OAuthProvider; label: string; icon: string; bg: string }[] = [
  {
    id: "oauth_google",
    label: "Google",
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
          ...
          <div className="px-8 py-5 border-t border-gray-50 bg-gray-50/50 text-center">
            <p className="text-sm text-gray-500">
              ليس لديك حساب؟{" "}
              <Link href="/sign-up" className="text-orange-500 font-bold hover:text-orange-600 transition-colors">
                أنشئ حساباً
              </Link>
            </p>
          </div>
